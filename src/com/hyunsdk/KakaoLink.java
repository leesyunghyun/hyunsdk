...
public class KakaoLink {
	 ...
	 *            recommend UTF-8
	 */
	public void openKakaoLink(Activity onClickListener, String url, String message, String appId, String appVer, String appName, String encoding) {
		...
		openKakaoLink(onClickListener, params);
	}
